...
> 
##### If you're interested in learning more about the author's professional background and decade long financial experience prior to their career transition into the new world of FinTech: [_click here to view my LinkedIn profile_](https://www.linkedin.com/in/alexis-reyes-21916456/). <!-- If you have the project hosted somewhere, include the link here. -->
---
...
### *Remember as a kid trading anything of value for a piece of gum?*
  ...
  > One company decided to incorporate the same fundamental rules applicable in the playground or lunch caferias worldwide, through a simple, digitial offering by the name of Klarna. 
